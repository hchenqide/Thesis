...
We conducted performance testing on cvc5 using MiniSatUP backend with benchmark \code{QF_LRA} from SMT-LIB benchmark library \cite{https://doi.org/10.5281/zenodo.16740866}, along with the existing integration of MiniSat and CaDiCaL in cvc5. The result is displayed in Table~\ref{tab:perf}.
